...
def run_pipeline(file_name):
    ...
    with open(f'results_for_rq1/results_{file_name}_exp1.json', 'a') as write_file:
        result_dict = {}
...
if __name__ == "__main__":
    ...
    artifact_names = ['commit_sharings_multiple', 'discussion_sharings_multiple', 'issue_sharings_multiple', 'file_sharings_multiple', 'hn_sharings_multiple', 'pr_sharings_multiple']

    # # commit sharing pipeline
    run_pipeline('sample2')
